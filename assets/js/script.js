...
const firebaseConfig = {
    apiKey: "AIzaSyAlhqtBfHRcCaHUcVmTUmeJsPZjTFXHQWk",
    authDomain: "fish-feeder-b6d29.firebaseapp.com",
    databaseURL: "https://fish-feeder-b6d29-default-rtdb.firebaseio.com",
    projectId: "fish-feeder-b6d29",
    storageBucket: "fish-feeder-b6d29.appspot.com",
    messagingSenderId: "1015762035214",
    appId: "1:1015762035214:web:17f433d34de4c53a09925f",
    measurementId: "G-G7LKM3MXV1"
  };
...
firebase.database().ref('/').on('value',(snapshot)=>{
    const Lastfeed=snapshot.child('HH','MM').val();
} );

/*var successTime = firebase.database().ref('HH','MM')
  successTime.on('value', function(snapshot) {
